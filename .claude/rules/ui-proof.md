...
## Requirements
- Every UI change must have a corresponding proof plan in `docs/TEST_PLAN.md` or the task section of `docs/CONFIDENCE_SCORE.md`.
- Proof can include:
  ...
  - User acceptance notes or stakeholder sign‑off (documented in `docs/FEEDBACK_LOG.md`).
...
## Failure Learning
- If a UI regression slips through, update this rule with the missing evidence type and record the incident in `docs/PROJECT_STATUS.md`.
