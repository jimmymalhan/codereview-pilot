...
9. **No direct main** - No commits go directly to main. Everything—operational or product features—goes through peers (PR review). Zero exceptions. Create feature branch first. Merge to main only via PR. See `no-direct-main` skill.
